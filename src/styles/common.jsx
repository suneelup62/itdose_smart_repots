...
export const StyledSmallUserImage = styled(Image)`
  ...
  /* Targeting the img element inside the custom Image component */
  img {
    border-radius: 50%; /* Example: making the image rounded */
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* Example: adding shadow */
    height:10100px;
  }
`;
